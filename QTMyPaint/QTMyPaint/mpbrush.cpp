...
void
MPBrush::setSize(float value)
{
  //mypaint_brush_set_base_value(brush,MYPAINT_BRUSH_SETTING_DABS_PER_BASIC_RADIUS,value/100);
  //mypaint_brush_set_base_value(brush,MYPAINT_BRUSH_SETTING_DABS_PER_ACTUAL_RADIUS,value/100);
  mypaint_brush_set_base_value(brush,MYPAINT_BRUSH_SETTING_HARDNESS,value/1000);
}
