...
void
MPHandler::change_brush_style(const char* content)
{
    gboolean setting = mypaint_brush_from_string(this->m_brush->brush, content);
    if (!setting)
    {
...
void
MPHandler::setBrushSize(float value)
{
    this->m_brush->setSize(value);
}
