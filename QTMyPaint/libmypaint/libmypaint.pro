...
#win32:CONFIG(release, debug|release): LIBS += -L$$PWD/C:/Program Files/Git/json-c/release/ -ljson-c
#else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/C:/Program Files/Git/json-c/debug/ -ljson-c
#else:unix: LIBS += -L$$PWD/C:/Program Files/Git/json-c/ -ljson-c

#INCLUDEPATH += $$PWD/C:/Program Files/Git/json-c/Debug
#DEPENDPATH += $$PWD/C:/Program Files/Git/json-c/Debug
